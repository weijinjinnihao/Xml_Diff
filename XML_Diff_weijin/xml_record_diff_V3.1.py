...
def run(interval, ip, username, password, port,ignore_list,node1_name,node2_name,file1,file2,result,now, To_see_record_same):
    print_ts("-"*100)
    ...
    while True:
        try:
            ...
            file1_list = xml_to_list.getXmlData(file1, ignore_list)
            file2_list = xml_to_list.getXmlData(file2, ignore_list)
            ...
            if (len1 != len2):
                ...
                result.append(
                    ["    The range of Record's TXID of " + node1_name + ": " + "[" + file1_list[0][3][1] + "," +
                     file1_list[-1][3][1] + "]"])
                result.append(["    \n"])
                result.append(["    The length of Record of " + node1_name + ": " + str(len2)])
                result.append(
                    ["    The range of Record's TXID of " + node1_name + ":" + "[" + file2_list[0][3][1] + "," +
                     file2_list[-1][3][1] + "]"])
            else:
...
if __name__ == '__main__':
    ...
    # ip2 = '192.168.0.42'
    # ip3 = '192.168.0.44'
    ip=["192.168.0.41","192.168.0.42","192.168.0.44"]
    username = 'root'
    password = '111111'
    port = 22
    ...
    while (True):
        if (node1_name == "NN41"):
            ...
            file1 = "/home/weijin_1/nn2_42.xml"
            break
        elif (node1_name == "NN44"):
            file1 = "/home/weijin_1/nn3_44.xml"
            break
        else:
    ...
    run(interval, ip, username, password, port, ignore_list, node1_name, node2_name, file1, file2, result, now,To_see_record_same)
